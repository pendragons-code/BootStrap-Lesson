...
function dummyData() {
	let  = document.getElementById("usernameField").value = dum
	let  = document.getElementById("emailField").value = 
	let  = document.getElementById("passwordField").value = dum
	let  = document.getElementById("dobField").value 
	let  = document.getElementById("charactersField").value = dummy
