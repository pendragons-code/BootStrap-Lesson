...
function dummyData() {
	...
	document.getElementById("usernameField").value = dummyData.email;
	document.getElementById("usernameField").value = dummyData.password;
	document.getElementById("usernameField").value = dummyData.dob;
	document.getElementById("usernameField").value = dummyData.charca;
}